...
impl From<crate::syntax_tree::mini_gringo::Predicate> for Predicate {
    fn from(value: crate::syntax_tree::mini_gringo::Predicate) -> Self {
        Predicate {
            symbol: value.symbol,
            arity: value.arity,
        }
...
impl From<crate::syntax_tree::mini_gringo::Relation> for Relation {
    fn from(value: crate::syntax_tree::mini_gringo::Relation) -> Self {
        match value {
            crate::syntax_tree::mini_gringo::Relation::Equal => Relation::Equal,
            crate::syntax_tree::mini_gringo::Relation::NotEqual => Relation::NotEqual,
            crate::syntax_tree::mini_gringo::Relation::Greater => Relation::Greater,
            crate::syntax_tree::mini_gringo::Relation::Less => Relation::Less,
            crate::syntax_tree::mini_gringo::Relation::GreaterEqual => Relation::GreaterEqual,
            crate::syntax_tree::mini_gringo::Relation::LessEqual => Relation::LessEqual,
        }
    }
}
